...
assert.ok(deployment.includes("EXPECTED_ADMIN_VERSION: '5.10'"));
...
console.log(`Phase 12 filtering, manual cover colors, Studio cleanup, local themes, metadata layout and Discography order remain valid under current Track Manager v5.10 / Build ${build.number}.`);
