...
const candidateDocs = new Map([
  ...
  [
    'audiolab-neon-ribbon-v13-clean-dynamic-camera-20260825',
    'docs/BUILD111-AUDIOLAB-NEON-RIBBON-V13-CLEAN-DYNAMIC-CAMERA.md'
  ],
  [
    'audiolab-neon-ribbon-v14-audio-range-20260825',
    'docs/BUILD112-AUDIOLAB-NEON-RIBBON-V14-AUDIO-RANGE.md'
  ],
  [
    'audiolab-neon-ribbon-v15-capsule-perspective-20260825',
    'docs/BUILD113-AUDIOLAB-NEON-RIBBON-V15-CAPSULE-PERSPECTIVE.md'
  ],
  [
    'audiolab-neon-ribbon-default-20260825',
    'docs/BUILD114-AUDIOLAB-NEON-RIBBON-DEFAULT.md'
  ],
  [
  ...
  [
    'audiolab-silk-flow-20260827',
    'docs/BUILD120-AUDIOLAB-SILK-FLOW.md'
  ]
]);
