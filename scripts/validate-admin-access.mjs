...
if (resolveLrcMakerAccess({ search: '?admin=0', storage, desktop: true })) throw new Error('LRC Maker admin opt-out failed.');
...
console.log('Desktop Track Manager and LRC Maker share persistent admin access across browser and installed PWA sessions.');
