...
assert.equal(activeId, '20260806-audiolab-unified-v2', 'The active runtime cache key must match Build 25.');
assert.ok(build.includes("const stylesheetVersion = visualTest ? '20260806-audiolab-unified-v2' : config.id"));
