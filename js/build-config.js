(() => {
  const config = Object.freeze({
    id: '20260824-audiolab-neon-ribbon-v9-exact-projection-build107',
    cache: 'shinobi-launchpad-v107',
    revision: 'audiolab-neon-ribbon-v9-exact-projection',
    display: '2026.08.24.107',
