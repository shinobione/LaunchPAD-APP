(() => {
  const config = Object.freeze({
    id: '20260824-audiolab-neon-ribbon-v7-source-port-build105',
    cache: 'shinobi-launchpad-v105',
    revision: 'audiolab-neon-ribbon-v7-source-port',
    display: '2026.08.24.105',
