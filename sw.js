...
const SHELL_RESOURCES = [
  ...
  './js/features/lyrics/lyrics-engine.js','./js/features/visual/visual-engine.js','./js/features/visual/visual-engine-v2.js','./js/features/media-session.js','./js/features/queue-ui.js',
